                    ...
                    <div className="flex gap-8">
                        <div className="relative h-20 w-20 flex-shrink-0">
                            <div className="h-full w-full overflow-hidden rounded-full border-2 border-dashed border-border bg-muted/50 p-1">
                                <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Shubhangi" alt="Avatar" className="h-full w-full rounded-full object-cover" />
                            </div>
                        </div>

                        <div className="grid flex-1 grid-cols-2 gap-6">
                            <InputField label="First name" value="Shubhangi" />
                            <InputField label="Last name" value="Gupta" />
                        </div>
                    </div>
                </div>
                ...
                <div className="rounded-2xl border border-border bg-card p-8 transition-colors duration-300">
                    <div className="flex items-start gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground mt-1">Choose your preferred language to use LeadIntel</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-end gap-4">
                        <div className="flex-1">
                            <div className="relative">
                                ...
                                <select className="w-full appearance-none rounded-xl border border-input bg-background pl-12 pr-4 py-3 text-sm text-foreground outline-none focus:border-blue-500/50 transition-colors">
